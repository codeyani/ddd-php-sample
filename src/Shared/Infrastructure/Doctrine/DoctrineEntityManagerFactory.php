...
namespace Codeyani\Shared\Infrastructure\Doctrine;

use Codeyani\Shared\Infrastructure\Doctrine\Dbal\DbalCustomTypesRegistrar;
...
final class DoctrineEntityManagerFactory
{
	private static array $sharedPrefixes = [
		__DIR__ . '/../../../Shared/Infrastructure/Persistence/Mappings' => 'Codeyani\Shared\Domain',
	];
