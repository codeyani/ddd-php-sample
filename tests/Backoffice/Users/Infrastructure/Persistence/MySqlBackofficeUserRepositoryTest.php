...
final class MySqlBackofficeUserRepositoryTest extends BackofficeUsersModuleInfrastructureTestCase
{
	/** @test */
	public function it_should_save_a_valid_user(): void
	{
		$this->mySqlRepository()->save(BackofficeUserMother::create());
	}
}
