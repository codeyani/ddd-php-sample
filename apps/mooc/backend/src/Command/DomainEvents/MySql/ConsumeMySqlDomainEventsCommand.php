...
namespace Codeyani\Apps\Mooc\Backend\Command\DomainEvents\MySql;

use Codeyani\Shared\Domain\Bus\Event\DomainEvent;
use Codeyani\Shared\Infrastructure\Bus\Event\DomainEventSubscriberLocator;
use Codeyani\Shared\Infrastructure\Bus\Event\MySql\MySqlDoctrineDomainEventsConsumer;
use Codeyani\Shared\Infrastructure\Doctrine\DatabaseConnections;
...
#[AsCommand(name: 'codeyani:domain-events:mysql:consume', description: 'Consume domain events from MySql',)]
